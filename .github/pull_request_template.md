...
- [ ] The [sensors-deploy:master](https://ci.instana.io/teams/sensors/pipelines/sensors-deploy:master) Concourse CI build successfully finished (checkout [#tech-sensors-delivery-notifications](https://instana.slack.com/archives/C047QU12MUP) Slack channel, ask for access in [#brewery-sensors](https://instana.slack.com/archives/G9T01QQUQ)): INSERT_LINK_TO_THE_BUILD_JOB_HERE
